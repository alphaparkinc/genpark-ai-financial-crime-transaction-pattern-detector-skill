class AiFinancialCrimeTransactionPatternDetectorClient:
    def analyze_transactions(self, transaction_sequence: list = None, account_id: str = "ACC-77821") -> dict:
        ...
        patterns = [
            {
                "pattern": "STRUCTURING",
                "description": "9 cash deposits of $9,800-$9,950 over 14 days, consistently below $10K CTR threshold.",
                "confidence": 96.2
            },
            {
                "pattern": "LAYERING",
                "description": "Rapid fund movement: deposited to 3 shell entities then consolidated back within 72hrs.",
                "confidence": 88.7
            }
        ]
        sar_lines = [
